...

        {
          ...
          table: {
            ...
            body: [
              ...
              [ 'GLASS', this.GH001, this.GH001storagemassz ],
              [ 'NON-FERROUS', this.NFAL01, this.NFAL01storagemassz ],
              [ 'PAPER', this.PAP005, this.PAP005storagemassz ],
              [ '', this.PAP007, this.PAP007storagemassz ],
              [ '', this.PAP001, this.PAP001storagemassz ],
              [ '', this.PAP003, this.PAP003storagemassz ],
              [ 'PLASTIC', this.HD001, this.HD001storagemassz ],
